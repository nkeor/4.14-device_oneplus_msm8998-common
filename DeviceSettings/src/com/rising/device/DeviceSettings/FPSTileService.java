...
import com.rising.device.DeviceSettings.R;
...
public class FPSTileService extends TileService {
  ...
  public void onStartListening() {
      ...
      for (ActivityManager.RunningServiceInfo service :
          ...
          if (com.rising.device.DeviceSettings.FPSInfoService.class.getName().equals(
  ...
  @Override
  public void onClick() {
      Intent fpsinfo = new Intent(this, com.rising.device.DeviceSettings.FPSInfoService.class);
      if (!isShowing)
